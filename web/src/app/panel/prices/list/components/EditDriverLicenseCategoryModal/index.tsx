...
export function EditDriverLicenseCategoryModal({ driverLicenseCategory }: EditScheduledDrivingLessonModalProps) {
    ...
    <AlertDialog open={isModalOpen} onOpenChange={setIsModalOpen}>
      ...
      <AlertDialogContent className="w-full max-w-xl overflow-y-auto">
        <div className="flex justify-between">
          ...
          <AlertDialogCancel className="outline-none border-0 shadow-none">
            <X size={20} />
          </AlertDialogCancel>
        </div>
