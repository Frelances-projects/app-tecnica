...
export function DeleteInformationModal({ id, title }: DeleteInformationModalProps) {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Essa ação não pode ser desfeita. Isso excluirá permanentemente o alerta <span className="font-bold">{title}</span>{` `}
