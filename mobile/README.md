...
> <b>App Técnica</b> é uma aplicação fullStack criada para uma auto escola de Portugal
...
```bash
# Clone o Repositório
$ git@github.com:Frelances-projects/app-tecnica.git
```
...
Feito com 💜 by Rodrigo Rael e João Vitor rodrigues
...
<a href="https://www.linkedin.com/in/devfront-jovi-souza/" target="_blank"> <img src="https://img.shields.io/badge/-RodrigoRael-blue?style=flat-square&logo=Linkedin&logoColor=white&link=https" alt="Linkedin João"> </a>
